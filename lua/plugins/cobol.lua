...
return{
    {'Jorengarenar/COBOl.vim',
        config = function()
            ...
            vim.g.cobol_autoupper = 0 -- automatic make letters uppercase
            vim.g.cobol_indent_data_items = 0 --[[ indentation of items in DATA DIVISION 
            0 - all in area A, 1 - to area B, 2 - each level more indented)]]--
            vim.g.cobol_indent_id_paras = 0 -- indent paragraphs in IDENTIFICATION DIVISION to area B
